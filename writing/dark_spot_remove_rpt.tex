...
See Table \ref{tab:prop_correct_test} in Appendix \ref{app:prop_corr} for full results.
...
\section{Complete results for proportional adjustment with darkspot correction}\label{app:prop_corr}
