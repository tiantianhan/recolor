...
\nomenclature{$\mean{C_S}$}{The average RGB colour of the output hand}
\nomenclature{$W$}{The subset of pixels used to calculate the average colour of the hand in the output image}
