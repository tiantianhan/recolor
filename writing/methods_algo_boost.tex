...
\nomenclature{$U$}{The subset of pixels used to calculate the average color of the hand in the target image}
\nomenclature{$V$}{The subset of pixels used to calculate the average color of the hand in the source image}
...
\nomenclature{$\mean{C_T}$}{The average RGB color of the target hand}
\nomenclature{$\mean{C_S}$}{The average RGB color of the source hand}
