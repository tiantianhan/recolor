...
\begin{longtable}{|c||c|c|c|}
    \caption*{Portion of test results of simple addition / subtraction brightening function from Table \ref{tab:boost_test} in Appendix \ref{app:boost}}\\
    \hline
    No. & Original & Target & Result \\ 
