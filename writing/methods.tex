...
We could try to bring back darker shadows and detail to the transformed image by making the previous correction algorithm apply for a narrower range of colour, distinguishing between shadow and dark spots and creases of the hand. 

We should also apply a different algorithm for hands transforming from lighter skin tones to darker skin tones, possibly adding the characteristic darker regions on a hand of darker skin tone instead of removing it.
