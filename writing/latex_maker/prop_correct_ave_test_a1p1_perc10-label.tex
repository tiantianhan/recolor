\begin{longtable}{|N||c|c|c|}
	\caption{Test results of proportional brightening with correction for dark spots, $\alpha$ = 1.1, using brightest 10 percent of pixels to calculate average colour \label{tab:prop_correct_test_a1p1_ave10}}\\
	\hline
